...
echo -e "${GREEN}╚══════════════════════════════════════════════════╝${RESET}"
echo ""
echo -e "${BOLD}🎬 Hackathon-Showcase (empfohlen für Demo):${RESET}"
echo -e "  ${BOLD}${CYAN}comptext demo stemi${RESET}               ${DIM}# 20s End-to-End: ePA → PHI → DSL → MedGemma${RESET}"
echo -e "  ${BOLD}${CYAN}comptext compare stemi${RESET}            ${DIM}# FHIR vs DSL: Kosten & Latenz (4 Modelle)${RESET}"
echo -e "  ${BOLD}${CYAN}comptext llm sepsis${RESET}               ${DIM}# MedGemma-27B-Antwort auf DSL-Frame${RESET}"
echo -e "  ${BOLD}${CYAN}comptext doctor${RESET}                   ${DIM}# Systemcheck (Demo-Bereitschaft)${RESET}"
echo ""
